...
For more information on releases since then, see [CHANGELOG.md](https://github.com/michael-milette/moodle-local_mailtest/blob/master/CHANGELOG.md).
...
http://github.com/michael-milette/moodle-local_mailtest/issues
